...
This plot shows the number of people per 100,000 population killed by police from 2013 through 2019 by race. From this graph, those identifying as Black, Native American, and Pacific Islander are the victims of most incidents of police violence. This holds relatively steady throughout this time period. This finding is consistent with recent findings showing the Black Americans are disproportionately affected by police violence. A limitation of this plot is that it does not include the Hispanic population as a separate group. This is because the population counts came from the US Census and the census does not consider Hispanic as a race category.
