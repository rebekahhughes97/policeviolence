...
The above plot compares the total US population estimate by race according to ACS data (left) compared with the total number of people killed by police broken down by race (race). As we can see, a much higher proportion of those who are killed by police are black when compared to the total population. 
