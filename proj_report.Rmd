...
<br>The following plot displays the proportion of individuals killed by police from 2013-2020 by race. According to the data displayed in the plot below, the most killings have occurred among those identifying as Black, Native American, and Pacific Islander. This finding is consistent with recent findings showing the Black Americans are disproportionately affected by police violence. While the original MPV dataset contains information about those identifying as Hispanic, census data did not capture total population, thus making proportions not possible for this plot. This plot along with the map above were used in informing what the regression analysis would examine for this dataset.
