...
Overall, the findings for the police violence data were not all consistent with what we had expected. While we did find that most of the cases did not result in criminal charges to the officer involved in the exploratory analysis, the regression analysis model 1 revealed that officers involved in the killing of Black individuals were more likely to be charged. This could have been for reasons outside of what the data offered though, such as the killing being unjustified in more cases of Black individual deaths than in White individual deaths.
<br>We also found that White individuals had higher numbers of deaths recorded than any other race. However, we were not able to find if this is a result of lack of recorded cases of Black individual deaths due to police. The regression analysis for model 2 further revealed that there was no association between gender and mental illness, which had been introduced in the first regression model.

&nbsp;

There were similarly unexpected but interesting findings in the protest data analysis as well. In the exploratory analysis we found that states with larger populations and large cities, including California, New York, and Florida, overall held the highest numbers of demonstrations which was consistent with what was expected. However, the regression analysis found that the "very high" income group was much more likely to hold protests than other income groups. We thought that this could have potentially been due to the cities holding more protests and therefore having the higher income class, which would be consistent with the finding from the exploratory analysis. However, once adjusting for the overdispersion that was found in the original regression model for the protest data, it was determined that the income classes were not really significantly different from each other.
<br>Overall we had expected that lower income classes would be more likely to hold demonstrations, which did not hold true here. We do not have the exact reasons for the protests that are in the data so that could potentially be helpful in determining why the higher income was initially recorded as holding significantly more protests.
