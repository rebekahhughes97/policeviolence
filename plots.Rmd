...
Scatter plots comparing the average fatalities each day over the course of each month:
...
may =
  ...
  group_by(day) %>% 
  summarize(
    av_fatal = mean(fatalities)
  ) %>% 
  ggplot(aes(x = day, y = av_fatal)) +
  geom_smooth(se = FALSE) +
  labs(title = "Average Number of Fatalities in May",
...
june =
  ...
  ggplot(aes(x = day, y = av_fatal)) +
  geom_smooth(se = FALSE) +
  labs(title = "Average Number of Fatalities in June",
       y = "Average Fatalities")
...
july = 
  ...
  ggplot(aes(x = day, y = av_fatal)) +
  geom_smooth(se = FALSE) +
  labs(title = "Average Number of Fatalities in July",
       y = "Average Fatalities")
...
august =
  ...
  ggplot(aes(x = day, y = av_fatal)) +
  geom_smooth(se = FALSE) +
  labs(title = "Average Number of Fatalities in August",
       y = "Average Fatalities")
...
sept =
  ...
  ggplot(aes(x = day, y = av_fatal)) +
  geom_smooth(se = FALSE) +
  labs(title = "Average Number of Fatalities in September",
       y = "Average Fatalities")
...
oct = 
  ...
  ggplot(aes(x = day, y = av_fatal)) +
  geom_line() +
  labs(title = "Average Number of Fatalities in October",
       y = "Average Fatalities")
